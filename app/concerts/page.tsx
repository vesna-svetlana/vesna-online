      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-lg p-10 border-l-8 border-red-800">
          ...
          <div className="flex justify-center mb-10">
            ...
            <Image
              src="/images/concerts/poster-garmoniya.jpg"
              alt="Афиша выступления ансамбля народной песни «ВЕСНА»"
              width={900}
              height={1200}
              className="rounded-3xl shadow-xl w-full max-w-3xl object-contain"
            />
